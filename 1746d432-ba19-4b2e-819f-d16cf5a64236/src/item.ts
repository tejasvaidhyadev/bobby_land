...
let defaultStation = 'https://player.vimeo.com/external/676293821.m3u8?s=f8d6b28206c296cac92972c89d9712d4be06df68'
...
export default class Button implements IScript<Props> {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    billboard.addComponent(new GLTFShape('1746d432-ba19-4b2e-819f-d16cf5a64236/models/Screen_Independent.glb'))
    ...
    placeholderMaterial.albedoTexture = new Texture(
      props.image ? props.image : '1746d432-ba19-4b2e-819f-d16cf5a64236/images/stream.png'
    )
